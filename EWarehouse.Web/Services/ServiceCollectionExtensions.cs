...
namespace EWarehouse.Web.Services
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            string connectionString = configuration["ConnectionStrings:ConnectionMySql"];

            services.AddDbContext<ApplicationContext>(options => options.UseLoggerFactory(loggerFactory).EnableSensitiveDataLogging(true).UseMySQL(connectionString));
